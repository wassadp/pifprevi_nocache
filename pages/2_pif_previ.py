...
if uploaded_file is not None:
    ...
    #        name_courbes = "nouvellesCourbesPresentation"
        ...
        def HYPOTHESE_REP():
            return pd.read_excel(path_hyp, name_hyp)
        ...
        #        K CNT
                if dispatch_df['K CNT'][r] != 0:
                    ...
                    if str(m).endswith("5:00"):
                        ...
                        index_k_cnt = df_site[0][1].loc[(time_r == df_site[0][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[0][1]['jour'])].index
                        
                    else:
                        index_k_cnt = df_site[0][1].loc[(dispatch_df['Horaire théorique'][r] == df_site[0][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[0][1]['jour'])].index
                        
                    df_site[0][1]['charge'][index_k_cnt] += dispatch_df['K CNT'][r]
        ...
        #        K CTR
                if dispatch_df['K CTR'][r] != 0:
                    ...
                    if str(m).endswith("5:00"):
                        ...
                        l = [int(k) for k in t.split(':')]
                        time_r = time(hour = l[0], minute = l[1], second = l[2])
                        index_k_ctr = df_site[1][1].loc[(time_r == df_site[1][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[1][1]['jour'])].index
                        
                        if dispatch_df['A/D'][r] == 'A':
                            df_site[1][1]['charge'][index_k_ctr] += dispatch_df['K CTR'][r]
                        else:
                        ...
                        index_k_ctr = df_site[1][1].loc[(dispatch_df['Horaire théorique'][r] == df_site[1][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[1][1]['jour'])].index
        ...
        #        L CNT
                if dispatch_df['L CNT'][r] != 0:
                    ...
                    if str(m).endswith("5:00"):
                        ...
                        l = [int(k) for k in t.split(':')]
                        time_r = time(hour = l[0], minute = l[1], second = l[2])
                        index_l_cnt = df_site[2][1].loc[(time_r == df_site[2][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[2][1]['jour'])].index
                        
                    else:
                        index_l_cnt = df_site[2][1].loc[(dispatch_df['Horaire théorique'][r] == df_site[2][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[2][1]['jour'])].index
                    
                    df_site[2][1]['charge'][index_l_cnt] += dispatch_df['L CNT'][r]
        ...
        #        L CTR
                if dispatch_df['L CTR'][r] != 0:
                    ...
                    if str(m).endswith("5:00"):
                        ...
                        l = [int(k) for k in t.split(':')]
                        time_r = time(hour = l[0], minute = l[1], second = l[2])
                        index_l_ctr = df_site[3][1].loc[(time_r == df_site[3][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[3][1]['jour'])].index
                        
                        if dispatch_df['A/D'][r] == 'A':
                            df_site[3][1]['charge'][index_l_ctr] += dispatch_df['L CTR'][r]
                        else:
                            for i in range(len(l_courbe_t[2][1])):
                                if dispatch_df['Prov Dest'][r] in l_f_iata[i]:
                        ...
                        index_l_ctr = df_site[3][1].loc[(dispatch_df['Horaire théorique'][r] == df_site[3][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[3][1]['jour'])].index
    ...
    #                    M CTR
                if dispatch_df['M CTR'][r] != 0:
                    ...
                    if str(m).endswith("5:00"):
                        ...
                        l = [int(k) for k in t.split(':')]
                        time_r = time(hour = l[0], minute = l[1], second = l[2])
                        index_m_ctr = df_site[4][1].loc[(time_r == df_site[4][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[4][1]['jour'])].index
                        
                        if dispatch_df['A/D'][r] == 'A':
                            df_site[4][1]['charge'][index_m_ctr] += dispatch_df['M CTR'][r]
                        else:
                            for i in range(len(l_courbe_t[2][1])):
                                if dispatch_df['Prov Dest'][r] in l_f_iata[i]:
                        ...
                        index_m_ctr = df_site[4][1].loc[(dispatch_df['Horaire théorique'][r] == df_site[4][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[4][1]['jour'])].index
        ...
        #        Galerie EF
                if dispatch_df['Galerie EF'][r] != 0:
                    ...
                    if str(m).endswith("5:00"):
                        ...
                        l = [int(k) for k in t.split(':')]
                        time_r = time(hour = l[0], minute = l[1], second = l[2])
                        index_g_ef = df_site[5][1].loc[(time_r == df_site[5][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[5][1]['jour'])].index
                        
                    else:
                        index_g_ef = df_site[5][1].loc[(df_site[5][1]['heure'] == m)
                                    & (dispatch_df['Local Date'][r] == df_site[5][1]['jour'])].index
                    
                    df_site[5][1]['charge'][index_g_ef] += dispatch_df['Galerie EF'][r]
        ...
        #        C2F
                if dispatch_df['C2F'][r] != 0:
                    ...
                    if str(m).endswith("5:00"):
                        ...
                        l = [int(k) for k in t.split(':')]
                        time_r = time(hour = l[0], minute = l[1], second = l[2])
                        index_c2f = df_site[6][1].loc[(time_r == df_site[6][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[6][1]['jour'])].index
                        
                        
                    else:
                        index_c2f = df_site[6][1].loc[(dispatch_df['Horaire théorique'][r] == df_site[6][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[6][1]['jour'])].index
        ...
        #        C2G
                if dispatch_df['C2G'][r] != 0:
                    ...
                    if str(m).endswith("5:00"):
                        ...
                        l = [int(k) for k in t.split(':')]
                        time_r = time(hour = l[0], minute = l[1], second = l[2])
                        index_c2g = df_site[7][1].loc[(time_r == df_site[7][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[7][1]['jour'])].index
                        
                    else:
                        index_c2g = df_site[7][1].loc[(dispatch_df['Horaire théorique'][r] == df_site[7][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[7][1]['jour'])].index
        ...
        #        Liaison AC
                if dispatch_df['Liaison AC'][r] != 0:
                    ...
                    if str(m).endswith("5:00"):
                        ...
                        l = [int(k) for k in t.split(':')]
                        time_r = time(hour = l[0], minute = l[1], second = l[2])
                        index_ac = df_site[8][1].loc[(df_site[8][1]['heure'] == time_r)
                                    & (dispatch_df['Local Date'][r] == df_site[8][1]['jour'])].index
                        
                    else:
                        index_ac = df_site[8][1].loc[(dispatch_df['Horaire théorique'][r] == df_site[8][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[8][1]['jour'])].index
        ...
        #        Liaison BD
                if dispatch_df['Liaison BD'][r] != 0:
                    ...
                    if str(m).endswith("5:00"):
                        ...
                        l = [int(k) for k in t.split(':')]
                        time_r = time(hour = l[0], minute = l[1], second = l[2])
                        index_bd = df_site[9][1].loc[(time_r == df_site[9][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[9][1]['jour'])].index
                        
                    else:
                        index_bd = df_site[9][1].loc[(dispatch_df['Horaire théorique'][r] == df_site[9][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[9][1]['jour'])].index
        ...
        #        T3
                if dispatch_df['T3'][r] != 0:
                    ...
                    if str(m).endswith("5:00"):
                        ...
                        l = [int(k) for k in t.split(':')]
                        time_r = time(hour = l[0], minute = l[1], second = l[2])
                        index_t3 = df_site[10][1].loc[(time_r == df_site[10][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[10][1]['jour'])].index
                        
                    else:
                        index_t3 = df_site[10][1].loc[(dispatch_df['Horaire théorique'][r] == df_site[10][1]['heure'])
                                    & (dispatch_df['Local Date'][r] == df_site[10][1]['jour'])].index
    ...
    #                            pax_od_t1_s_i[i].append(r)
            ...
            st.write(end2 - start1)      
            my_bar.progress(o +10)     
            o += 10   
            l_ch_k_ctr = df_site[1][1]['charge'].tolist()
            convo_k_ctr = list(signal.convolve(l_ch_k_ctr, courbe_deb_k, mode='same'))
            df_site[1][1]['charge'] = convo_k_ctr 
            
            l_ch_l_ctr = df_site[3][1]['charge'].tolist()
            convo_l_ctr = list(signal.convolve(l_ch_l_ctr, courbe_deb_l, mode='same'))
            df_site[3][1]['charge'] = convo_l_ctr 
            
            l_ch_m_ctr = df_site[4][1]['charge'].tolist()
            convo_m_ctr = list(signal.convolve(l_ch_m_ctr, courbe_deb_m, mode='same'))
            df_site[4][1]['charge'] = convo_m_ctr 
        ...
        def TO_EXCEL(df_site, path):
            col = df_site[0][1].columns.tolist()
            
            df = pd.DataFrame(columns=col)
            df['jour'] = df_site[0][1]['jour'].tolist() * len(df_site)
            
            for i in range(len(df_site)):
                df['charge'][len(df_site[i][1])*i:len(df_site[i][1])*(i+1)] = df_site[i][1]['charge']
                df['heure'][len(df_site[i][1])*i:len(df_site[i][1])*(i+1)] = df_site[i][1]['heure']
                df['site'][len(df_site[i][1])*i:len(df_site[i][1])*(i+1)] = df_site[i][1]['site']
                df['type'][len(df_site[i][1])*i:len(df_site[i][1])*(i+1)] = df_site[i][1]['type']
